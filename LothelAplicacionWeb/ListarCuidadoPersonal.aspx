<%@ Page Title="" Language="C#" MasterPageFile="~/pMaestra.Master" AutoEventWireup="true" CodeBehind="ListarCuidadoPersonal.aspx.cs" Inherits="LothelAplicacionWeb.ListarCuidadoPersonal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bodyAdmin" runat="server">
        ...
        <div class="row m-1">
            ...
            <div class="col">
                <!-- Titulo del listado-->
                <p class="fontEvento">Productos de Cuidado Personal</p>
            </div>
        </div>
       ...
       <div class="container mb-3">
           <div class="row">
               ...
               <div class="col text-end">
                    <asp:LinkButton ID="lbRegistrarBebida" runat="server" CssClass="btn btn-success me-4" Text="<i class='fa-solid fa-plus pe-2'></i> Registrar Cuidado Personal" OnClick="lbRegistrarBebida_Click" />
               </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <asp:DropDownList ID="ddlCategoria" runat="server">
                                            ...
                                            <asp:ListItem Text="ASEO_PERSONAL" Value="ASEO_PERSONAL" />
                                            <asp:ListItem Text="SALUD_SEXUAL" Value="SALUD_SEXUAL" />
                                            <asp:ListItem Text="BIENESTAR_GENERAL" Value="BIENESTAR_GENERAL" />
                                        </asp:DropDownList>                                        
                                    </div>
                                     <!-- empresa proveedora -->
