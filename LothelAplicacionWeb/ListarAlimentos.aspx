<%@ Page Title="" Language="C#" MasterPageFile="~/pMaestra.Master" AutoEventWireup="true" CodeBehind="ListarAlimentos.aspx.cs" Inherits="LothelAplicacionWeb.ListarAlimentos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="bodyAdmin" runat="server">
    ...
    <div class="container">
        ...
        <!-- parte superior (arriba del gridView) -->
         <div class="row m-1">
             ...
             <div class="col">
                 <!-- Titulo del listado-->
                 <p class="fontEvento">Productos Alimenticios</p>
             </div>
         </div>
        ...
        <div class="container mb-3">
            <div class="row">
                ...
                <div class="col text-end">
                        <asp:LinkButton ID="lbRegistrarALimento" runat="server" CssClass="btn btn-success me-4" Text="<i class='fa-solid fa-plus pe-2'></i> Registrar Alimento" OnClick="lbRegistrarAlimento_Click" />
                </div>
    ...
    <!-- fin -->
        ...
        <div class="container row">
            <asp:GridView ID="gvAlimentos" runat="server"
                AllowPaging="true" PageSize="5" OnPageIndexChanging="gvAlimentos_PageIndexChanging" OnRowDataBound="gvBebidas_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton runat="server" Text="<i class='fa-solid fa-edit ps-2'></i>" OnClick="btnEditarAlimento" CommandArgument='<%# Eval("idIteam") %>' />
        ...
        <!-- MODAL PARA AGREGAR UN Alimento --->
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <asp:Label runat="server" ID="lblTituloModalAlimento" class="modal-title" Text="Registro de alimento"></asp:Label>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <asp:DropDownList ID="ddlCategoria" runat="server">
                                                ...
                                                <asp:ListItem Text="PLATOS" Value="PLATOS" />
                                     ...
                                     <!-- empresa proveedora -->
                                        ...
                                        <div class="col mt-4 text-end">
                                            <asp:LinkButton ID="lbConfirmarRegistroAlimento" runat="server" CssClass="btn btn-success" Text="<i class='fa-solid  fa-check pe-2'></i> Confirmar" OnClick="btnConfirmarRegistroAlimento" />
                                        </div>
