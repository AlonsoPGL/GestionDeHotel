<%@ Page Title="" Language="C#" MasterPageFile="~/pMaestra.Master" AutoEventWireup="true" CodeBehind="pPersonalDeLavanderia.aspx.cs" Inherits="LothelAplicacionWeb.pPersonalDeLavanderia" %>
...
.link_aux {
            ...
            <asp:GridView ID="GridTareasLavandero" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="7" CssClass="table table-hover table-responsive table-striped" OnPageIndexChanging="GridTareasLavandero_PageIndexChanging"  >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Detalle:">
                        <ItemTemplate>
                            <asp:LinkButton ID="btnVerDetalleLavandero" runat="server" Text="<i class='fa-solid fa-eye'></i>" OnClick="btnVerDetalleLavandero_Click" CommandArgument='<%# Eval("idPedido") %>'/>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h6><strong>Descripcion del pedido:</strong>
    ...
    <asp:GridView ID="GridTareasPorEntregarLavandero" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="7" CssClass="table table-hover table-responsive table-striped" OnPageIndexChanging="GridTareasPorEntregarLavandero_PageIndexChanging" >
        <Columns>
            <asp:BoundField DataField="idPedido" HeaderText="ID" />
            <asp:BoundField DataField="fechaSolicitud" HeaderText="Fecha Entrega:" />
            <asp:BoundField DataField="incidenciaDeHabitacion" HeaderText="Incidencia" />
            <asp:BoundField DataField="anotacionesServicio" HeaderText="Anotaciones" />
            <asp:TemplateField HeaderText="Incidencias:">
                <ItemTemplate>
                    <asp:LinkButton ID="btnComentarIncidencia" runat="server"  Text=" Incidencia" Class="btn btn-primary fa-solid  fa-eye" style="background-color:#d9a13c;border:none" Onclick="btnComentarIncidencia_Click" CommandArgument='<%# Eval("idPedido") %>'/>
        ...
        <div class="modal fade" id="Modal-Incidencia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:LinkButton Text="<i class='fa-solid fa-square-xmark'></i> Cerrar" runat="server"  />
                        <asp:LinkButton Text="<i class='fa-solid fa-square-check'></i> Guardar" runat="server"  OnClick="btnGuardarModalIncidencia_Click" CommandArgument='<%# Eval("idPedido") %>'/>
                    </div>
                </div>
            </div>
        </div>
